...
// TopicTransferReconciler reconciles a TopicTransfer object
type TopicTransferReconciler struct {
	client.Client
...
// the TopicTransfer object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.11.0/pkg/reconcile
func (r *TopicTransferReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *TopicTransferReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&rocketmqv1alpha1.TopicTransfer{}).
		Complete(r)
}
